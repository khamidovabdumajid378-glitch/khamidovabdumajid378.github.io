...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.timeline-item, .experience-card, .achievement-card, .skill-item');
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.social-link').forEach(link => {
        link.addEventListener('click', (e) => {
            const platform = link.classList[1]; // Gets the platform class (linkedin, instagram, etc.)
...
document.querySelectorAll('.contact-method a').forEach(link => {
    link.addEventListener('click', (e) => {
        const method = link.href.includes('mailto') ? 'email' : 
                     link.href.includes('wa.me') ? 'whatsapp' : 
                     link.href.includes('t.me') ? 'telegram' : 'other';
...
function createPreloader() {
    ...
    preloader.innerHTML = `
        <div style="text-align: center; color: white;">
            ...
            <h3 style="font-family: 'Playfair Display', serif; margin: 0;">Loading...</h3>
        </div>
        <style>
            @keyframes spin {
...
// createPreloader(); // Uncomment if you want a loading screen
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    safeQuerySelector('.hero-title .gradient-text', (element) => {
        const originalText = element.textContent;
        typeWriter(element, originalText, 80);
    });
    
    safeQuerySelector('.hero-stats', (element) => {
...
console.log('🚀 Khamidov Abdumajid\'s website loaded successfully!');